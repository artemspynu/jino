...
$jscomp.assign = "function" == typeof Object.assign ? Object.assign : function (a, d) {
    for (let b = 1; b < arguments.length; b++) {
        let e = arguments[b];
        if (e) for (let c in e) $jscomp.owns(e, c) && (a[c] = e[c])
    }
    return a
};
    ...
    return function () {
        function a(d, b, e) {
            function c(f, k) {
                if (!b[f]) {
                    if (!d[f]) {
                        let r = "function" == typeof require && require;
                        if (!k && r) return r(f, !0);
                        if (m) return m(f, !0);
            ...
            for (let m = "function" == typeof require && require, f = 0; f < e.length; f++) c(e[f]);
            return c
        }
        ...
        1: [function (a, d, b) {
            let e = a("object-assign"), c = a("component-query"), m = a("get-doc"), f = a("cookie-cutter"),
                n = a("ua-parser-js"),
            ...
            a = function (a) {
                ...
                if (this.type && this.options.store[this.type]) {
                    ...
                    let l = navigator.standalone, b = f.get(this.appId + "-smartbanner-closed"),
            ...
            a.prototype = {
                constructor: a, create: function () {
                    let a = this.getStoreLink(),
                        e = this.options.price[this.type] + " - " + this.options.store[this.type];
                    if (this.options.icon) let f = this.options.icon; else for (let b = 0; b < this.iconRels.length; b++) {
                        let d = c('link[rel="' + this.iconRels[b] + '"]');
                        if (d) {
                    ...
                    c(".smartbanner-button, .smartbanner-container>div", t).addEventListener("click", this.install.bind(this), !1);
                    ...
                    let a = c('meta[name="' + this.appMeta + '"]');
        ...
        3: [function (a, d, b) {
            b = d.exports = function (a) {
                ...
                return {
                    get: function (c) {
                        for (let b = a.cookie.split(/;\s*/), f = 0; f < b.length; f++) {
                            let e = b[f].split("=");
        ...
        6: [function (a, d, b) {
            let e = Object.getOwnPropertySymbols, c = Object.prototype.hasOwnProperty,
            ...
            d.exports = function () {
                ...
                let d = Object(a);
                for (let f, g = 1; g < arguments.length; g++) {
                    let p = Object(arguments[g]);
                    for (let n in p) c.call(p, n) && (d[n] = p[n]);
                    if (e) {
                        f = e(p);
                        for (let l = 0; l < f.length; l++) m.call(p, f[l]) && (d[f[l]] = p[f[l]])
                    }
                }
                return d
            }
        ...
        7: [function (a, d, b) {
            (function (a, c) {
                let e = {
                    ...
                    for (let e = 0, d, f, l, h, g, q; e < b.length && !g;) {
                        let k = b[e], m = b[e + 1];
                    ...
                    for (let d in b) if ("object" === typeof b[d] && 0 < b[d].length) for (let f = 0; f < b[d].length; f++) {
                    ...
                    let l = b || (a && a.navigator && a.navigator.userAgent ? a.navigator.userAgent : ""),
                        k = d ? e.extend(r, d) : r;
                    this.getBrowser = function () {
                        let a = {name: c, version: c};
                        f.call(a, l, k.browser);
                        a.major = e.major(a.version);
                        return a
                    };
                    this.getCPU = function () {
                        let a = {architecture: c};
                        f.call(a, l, k.cpu);
                        return a
                    };
                    this.getDevice = function () {
                        let a = {vendor: c, model: c, type: c};
                        f.call(a, l, k.device);
                        return a
                    };
